...
func1_output_R = pd.read_csv('/arcospy/arcospy/tests_datasets/func1_output.csv') 
...
func3_output_R = pd.read_csv('/arcospy/arcospy/tests_datasets/func3_output.csv') 
...
func5_output_R = pd.read_csv('/arcospy/arcospy/tests_datasets/func5_output.csv') 
...
func7_output_R = pd.read_csv('/arcospy/arcospy/tests_datasets/func7_output.csv') 
...
func9_output_R = pd.read_csv('/arcospy/arcospy/tests_datasets/func9_output.csv') 
...
func11_output_R = pd.read_csv('/arcospy/arcospy/tests_datasets/func11_output.csv') 
...
func13_output_R = pd.read_csv('/arcospy/arcospy/tests_datasets/func13_output.csv') 
